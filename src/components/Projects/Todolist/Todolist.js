        ...
        <div className={styles.sideBySide}>
          ...
          <div className={styles.sideBySideRightWrapper}>
            <div className={styles.sectionTextRightWrapper}>
              ...
              <p>
                I felt like it was vital for me to practice pure Javascript and React, so the only extra packages I used
                here were uuid for generating unique IDs, and react-spring for all the animations.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={styles.sideBySideLeftWrapper}>
            <div className={styles.sectionTextLeftWrapper}>
              <p>
                ...
                implement some sorting, so that tasks marked as completed would be moved to the bottom of the list, and
                back up if they were unmarked. Animating this probably took me the longest!
              </p>
            </div>
          </div>
          <div className={styles.sideBySideRightWrapper}>
          ...
          <div className={styles.sideBySideLeftWrapper}>
            <div className={styles.sectionTextLeftWrapper}>
              <p>
                ...
                formats it into a list of tasks. It supports lists separated by a hyphen (-), comma (,) or an underscore
                (_) and uses those symbols as separators, creating an array of strings and adding each string as a task
                while removing trailing spaces at the start, putting the string into lower case and then capitalizing
                the first character for improved usability and readability.
              </p>
            </div>
          </div>
          <div className={styles.sideBySideRightWrapper}>
        ...
        <div className={styles.sectionTextCenterWrapper}>
          <div className={todostyles.lessonTextWrapper}>
            <p ref={lessonRef}>
              ...
              taught me a lot about how Javascript and React work, as well as how important it is to flesh out business
              logic before starting the actual development process.
            </p>
            <p>
              I am also quite proud of the visuals I was able to achieve. Everything moves smoothly and is animated with
              adorable springs which are very pleasing to the eye. This was my first introduction to spring animations,
