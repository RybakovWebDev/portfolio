...
const project = PROJECTS.filter((p) => p.slug === "PairLearner")[0];
            ...
            <div className={styles.sideBySideLeftWrapper}>
              <GradientBorders topBorder={"20px"} rightBorder={"30px"} bottomBorder={"20px"} leftBorder={"30px"}>
                <EmbedVideo
                  ...
                  height={calculateVideoHeight(viewportSize.width, 500, 400)}
                  showSpinner={true}
                />
              </GradientBorders>
            </div>
            ...
            <div className={styles.sideBySideRightWrapper}>
              <GradientBorders topBorder={"20px"} rightBorder={"30px"} bottomBorder={"20px"} leftBorder={"30px"}>
                <EmbedVideo
                  ...
                  height={calculateVideoHeight(viewportSize.width, 475, 220)}
                  showSpinner={true}
                />
              </GradientBorders>
            </div>
