    ...
    <div className={styles.page}>
      ...
      <div className={styles.sectionTextCenterWrapper}>
        <p className={styles.sectionTextIntro}>
          ...
          AI bot that talks about anything related to movies. Registered users can create and share watchlists that are
          visible to anyone.
        </p>
      </div>
      ...
      <div className={styles.section}>
          ...
          <div className={styles.sideBySideRightWrapper}>
            <div className={styles.sectionTextRightWrapper}>
              <p>
                ...
                information about movies, but the project quickly grew in scale. Eventually I also decided to implement
                user accounts where they could edit their names and upload custom profile pictures as well as create,
                edit and share movie watchlists, with drag and drop support for lists, with everything smoothly
                animated. As I was working on this, ChatGPT began to really blow up, so I also wanted to to practice
                working with AI chatbots by using including it. Last but not least, it was important for me to make the
                website responsive and functional on devices with different screen sizes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={viewportWidth > 1430 ? styles.sideBySide : styles.sideBySideReversed}>
          <div className={styles.sideBySideLeftWrapper}>
            <div className={styles.sectionTextLeftWrapper}>
              <p>
                React was a natural fit for ease of working with UI and a large ecosystem. I used the hooks heavily for
                state management, while the context API was invaluable for sharing data easily across the application.
                To optimize search, I chose the custom use-debounce hook as it was a tiny, well-maintained package with
                zero dependencies. For the rest of the stack, a lot of it was dictated by what I wanted to practice
                with.
              </p>
            </div>
          </div>
        ...
        <div className={styles.sideBySide}>
          ...
          <div className={styles.sideBySideRightWrapper}>
            <div className={styles.sectionTextRightWrapper}>
              <p>
                For example, I wanted to gain some experience working with a component library, so I went with Material
                UI as it offered an impressive selection of components, great documentation, and was easily
          ...
          <div className={styles.sideBySideLeftWrapper}>
            <div className={styles.sectionTextLeftWrapper}>
              <p>
                ...
                application. EC2 was used for hosting the database, while S3 was used for storing profile images. I used
                Elastic Beanstalk for hosting the backend, Amplify for the frontend, and routed it through CloudFront
                for HTTPS. I also connected CodePipeline to the GitHub repository to automate the deployment process.
              </p>
            </div>
          </div>
          <div className={styles.sideBySideRightWrapper}>
          ...
          <div className={styles.sideBySideRightWrapper}>
            <div className={styles.sectionTextRightWrapper}>
              <p>
                ...
                deploying a db and interacting with it instead of using a service like Mongo Atlas or Firebase. Mongoose
                was used for cutting down on boilerplate and general streamlining of the development process.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={styles.sideBySideLeftWrapper}>
            <div className={styles.sectionTextLeftWrapper}>
              ...
              <p>
                ...
                gathered API data into several categories: general summary, cast, full crew, media (videos and posters),
                similar titles, and streaming services that offer the movie based on selected country.
              </p>
            </div>
          </div>
          <div className={styles.sideBySideRightWrapper}>
          ...
          <div className={styles.sideBySideRightWrapper}>
            <div className={styles.sectionTextRightWrapper}>
              <p>
                ...
                After some research I chose dnd kit due to its continued support and solid documentation. It integrated
                nicely with MUI, and I made sure to set it up correctly for use on devices with a touch screen.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={styles.sideBySideRightWrapper}>
            <div className={styles.sectionTextRightWrapper}>
              <p>
                ...
                expected this to be a difficult task, but as it turned out OpenAI has excellent documentation, and their
                API is pretty straightforward, so it only took me a day to figure it out and include it in the codebase.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className={styles.sideBySideLeftWrapper}>
            <div className={styles.sectionTextLeftWrapper}>
              <p>
                ...
                backend that automatically comes up with a cute unique animal name that the user can later change in the
                profile settings 😅
              </p>
            </div>
          </div>
        ...
        <div className={styles.sectionTextCenterWrapper}>
          <div className={MDSStyles.lessonList}>
            <p ref={lessonRef}>
              ...
              project structure, and how to best approach solving a lot of common and not so common challenges. Some of
              my personal highlights among the stuff I had to figure out:
            </p>
            ...
            <LazyMotion features={domAnimation}>
              <m.ul variants={container} initial='hidden' animate='show'>
                ...
                <m.li variants={item}>
                  <strong>JWT:</strong> used JSON Web Token to implement secure authentication and authorization for the
                  users
                </m.li>
                <m.li variants={item}>
